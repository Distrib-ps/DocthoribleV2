...
<a href="http://localhost/docthorible/login_patient.php"><input type="button" value="Login Patient !" /></a>
<a href="http://localhost/docthorible/login_medecin.php"><input type="button" value="Login Médecin !" /></a>
</li>
</ul>
</form>
</body>
